...
#ifdef PSPFAT
#define MIN_COMHUNKMEGS 10
#define DEF_COMHUNKMEGS "15"
#define DEF_COMZONEMEGS "2"
#else
...
void Com_InitZoneMemory( void )
{
    ...
    printf("Alloc Zone: %i\n",s_zoneTotal);
/*
    s_zoneTotal = 4 * 1024 * 1024;
	SceUID MUID = sysKernelAllocPartitionMemory( MEM_VOLATILE, "Quake3zone", PSP_SMEM_High, s_zoneTotal, NULL );
	mainzone = (void *)(uintptr_t)(sysKernelGetBlockHeadAddr( MUID ));
*/
...
void Com_InitHunkMemory( void )
{
	...
	printf("Alloc Hunk: %i\n",s_hunkTotal + 31);
/*
    SceUID MUID = sysKernelAllocPartitionMemory( MEM_USER, "Quake3hunk", PSP_SMEM_High, s_hunkTotal + 31, NULL );
	s_hunkData = (void *)( (uintptr_t)(sysKernelGetBlockHeadAddr( MUID )));
*/
