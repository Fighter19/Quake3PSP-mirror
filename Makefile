...
-lpspwlan -lstdc++ -lm -lpsppower -lpng -lz -Wl,--whole-archive -lpspuser -lpspge -lpsputility -lpspnet -lpspnet_inet -lpspnet_apctl -lpspnet_resolver -lpspkubridge -Wl,--no-whole-archive \
